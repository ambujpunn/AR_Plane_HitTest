...
SWIFT_MODULE_NAMESPACE_PUSH("NextReality_PlaneHitTest")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC24NextReality_PlaneHitTest11AppDelegate")
...
SWIFT_CLASS("_TtC24NextReality_PlaneHitTest14ViewController")
